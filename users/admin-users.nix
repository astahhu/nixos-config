{
  ...
  config = {
    astahhu.common.admin-users.florian = {
      setPassword = false;
      sshKeys = [
    ...
    astahhu.common.admin-users.felix = {
      ...
      sshKeys = [
       ...
       "ssh-rsa  iPhone Felix"
      ];
    };
  };
}
